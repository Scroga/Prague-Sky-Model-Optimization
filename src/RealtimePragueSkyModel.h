...
//  * channels ] * elevationCount ] * altitudeCount ] * albedoCount ] * visibilityCount
				...
				/////////////////////////////////////////////////////////////////////////////////////
public:
				RealtimePragueSkyModel() : initialized(false) {};
...
private:
				...
				/// configuration.
				std::vector<float>::const_iterator getCoefficientsTransBase(
								const int altitude,
								const int a,
								const int d) const;
				...
				/// configuration.
				std::vector<float>::const_iterator getCoefficientsTrans(
								const int visibility,
								const int altitude,
								const int wavelength) const;

				/// Interpolates transmittances computed for two nearest altitudes.
				double interpolateTrans(
				...
				InterpolationParameter getInterpolationParameterTrans(
								const double value,
				...
				TransmittanceParameters toTransmittanceParams(
								const double theta,
