...
/////////////////////////////////////////////////////////////////////////////////////
// Tables that use Vector3
/////////////////////////////////////////////////////////////////////////////////////

// Spectral response table used for converting spectrum to XYZ.
inline constexpr Vector3 SPECTRAL_RESPONSE[] = {
...
inline double doubleFromHalf(const uint16 half) {
...
inline std::tuple<double, double> isectToAltitudeDistance(const double isectX, const double isectY) {
...
inline double intersectRayWithCircle2D(const double rayDirX,
...
inline Vector3 pixelToDirection(int x, int y, int resolution, View view) {
...
inline Vector3 spectrumToRGB(const Spectrum& spectrum) {
    // Spectrum to XYZ
    Vector3 xyz = Vector3();
