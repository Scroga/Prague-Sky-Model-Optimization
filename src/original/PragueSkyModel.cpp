...
AvailableData PragueSkyModel::getAvailableData() const {
    if (!initialized) {
...
Parameters PragueSkyModel::computeParameters(const Vector3& viewpoint,
...
InterpolationParameter PragueSkyModel::getInterpolationParameter(
...
InterpolationParameter PragueSkyModel::getInterpolationParameterTrans(const double value,
...
TransmittanceParameters PragueSkyModel::toTransmittanceParams(const double theta,
